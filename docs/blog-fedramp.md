# Why Most LLM Gateways Can't Pass a FedRAMP Review (And What Can)
...
1. Read the [Air-Gapped Deployment Guide](https://github.com/isartor-ai/Isartor/blob/main/docs/AIR-GAPPED.md)
