...
The gateway exports traces and metrics via OTLP gRPC to whatever `ISARTOR__OTEL_EXPORTER_ENDPOINT` points at. See [Metrics & Tracing](../observability/metrics-tracing.md) for detailed setup.
